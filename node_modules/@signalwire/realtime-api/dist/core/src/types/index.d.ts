...
export interface EmitterContract<EventTypes extends EventEmitter.ValidEventTypes> {
    on<T extends EventEmitter.EventNames<EventTypes>>(event: T, fn: EventEmitter.EventListener<EventTypes, T>): EmitterContract<EventTypes>;
    once<T extends EventEmitter.EventNames<EventTypes>>(event: T, fn: EventEmitter.EventListener<EventTypes, T>): EmitterContract<EventTypes>;
    off<T extends EventEmitter.EventNames<EventTypes>>(event: T, fn?: EventEmitter.EventListener<EventTypes, T>): EmitterContract<EventTypes>;
    removeAllListeners<T extends EventEmitter.EventNames<EventTypes>>(event?: T): EmitterContract<EventTypes>;
}
...
export interface DisconnectableClientContract<ClientInstance, EventTypes extends EventEmitter.ValidEventTypes> extends Omit<ClientContract<ClientInstance, EventTypes>, 'connect'> {
}
