import { BaseComponentOptions, EventTransform, InternalVideoMemberEventNames, InternalVideoRoomSessionEventNames, VideoRoomAudienceCountEventNames, InternalVideoLayoutEventNames, InternalVideoRecordingEventNames, InternalVideoPlaybackEventNames, VideoRoomSessionContract, ConsumerContract, EntityUpdated, BaseConsumer, EventEmitter } from '@signalwire/core';
import { RealTimeRoomApiEvents } from '../types';
import { RoomSessionMember } from './RoomSessionMember';
declare type EmitterTransformsEvents = InternalVideoRoomSessionEventNames | VideoRoomAudienceCountEventNames | InternalVideoMemberEventNames | InternalVideoLayoutEventNames | InternalVideoRecordingEventNames | 'video.__local__.recording.start' | InternalVideoPlaybackEventNames | 'video.__local__.playback.start';
