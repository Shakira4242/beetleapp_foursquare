...
export interface CallDocs extends Pick<VoiceCallContract<Call>, InheritedMembers>, EmitterContract<RealTimeCallApiEvents> {
    ...
    headers?: SipHeader[];
    dial(params: VoiceDeviceBuilder | {
     ...
     * ```
     */
    hangup(reason?: 'hangup' | 'cancel' | 'busy' | 'noAnswer' | 'decline' | 'error'): Promise<void>;
    /**
     ...
     * ```
     */
    waitFor(params: ('ending' | 'ended') | ('ending' | 'ended')[]): Promise<boolean>;
    /**
...
export {};
//# sourceMappingURL=Call.docs.d.ts.map