...
var RoomSessionMemberComponent = class extends import_core.BaseComponent {
  remove() {
...
var RoomSessionMemberAPI = (0, import_core.extendComponent)(RoomSessionMemberComponent, {
  audioMute: import_core.Rooms.audioMuteMember,
  audioUnmute: import_core.Rooms.audioUnmuteMember,
  videoMute: import_core.Rooms.videoMuteMember,
  videoUnmute: import_core.Rooms.videoUnmuteMember,
  setDeaf: import_core.Rooms.setDeaf,
  setMicrophoneVolume: import_core.Rooms.setInputVolumeMember,
  setInputVolume: import_core.Rooms.setInputVolumeMember,
  setSpeakerVolume: import_core.Rooms.setOutputVolumeMember,
  setOutputVolume: import_core.Rooms.setOutputVolumeMember,
  setInputSensitivity: import_core.Rooms.setInputSensitivityMember
});
var createRoomSessionMemberObject = (params) => {
  const member = (0, import_core.connect)({
    store: params.store,
...
var VideoClient = function(options) {
  ...
  client.on("session.connected", () => __async(this, null, function* () {
    try {
    ...
    return /* @__PURE__ */ new Map([
      [
        ["calling.prompt.ended", "calling.prompt.failed"],
        {
          ...
          payloadTransform: (payload) => {
            return (0, import_core37.toExternalJSON)(payload);
          }
        }
      ]
    ]);
