...
export declare const getRecordings: RoomMethodDescriptor<GetRecordingsOutput, RoomMethodParams>;
export declare const startRecording: RoomMethodDescriptor<void>;
interface GetPlaybacksOutput {
    playbacks: VideoPlaybackEntity[];
}
export declare const getPlaybacks: RoomMethodDescriptor<GetPlaybacksOutput, RoomMethodParams>;
